...
if(isset($_POST['name'])){
    ...
    $sql = "INSERT INTO `untrip`.`trip` (`name`, `age`, `gender`, `email`, `phone`, `destination`, `date`) VALUES ('$name', '$age', '$gender', '$email', '$phone', '$destination', current_timestamp());";
    // echo $sql;
...
<body>
    <img class="img" src="img.jpg" alt="NULL">
    <div class="container">
